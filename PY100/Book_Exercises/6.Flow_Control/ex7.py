...
def number_range(number):
    if number < 0:
        print(f'the value {number} is less than 0')
    elif number < 51:
        print(f'the value {number} is between 0 and 50')
    elif number < 101:
        print(f'the value {number} is between 51 and 100')
    else:
        print(f'the value {number} is greater than 100')
