...
| ------------------------------- | ----------- | --------- | ------------- | ------- |
| [ranges](11.ranges.md)          | `range`     | sequences | Non-primitive | No      |
| [tuples](12.lists)              | `tuple`     | sequences | Non-primitive | No      |
| [lists](12.lists)               | `list`      | sequences | Non-primitive | **Yes** |
| [dictionaries](14.dictionaries.md) | `dict`      | mappings  | Non-primitive | **Yes** |
